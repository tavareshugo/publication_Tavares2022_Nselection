...
# convert SNP alleles to numeric - convenient to calculate frequencies downstream
# 0 = reference and 1 = alternative
accessions_genotypes$snp_allele <- as.integer(accessions_genotypes$snp_allele == accessions_genotypes$ref)
